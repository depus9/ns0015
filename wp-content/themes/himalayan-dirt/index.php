...
<div class="row">
  <div id="primary" class="site-main-content" data-aos="zoom-in">
    <header class="page-title sr-only">
      <h1>Himalayan Dirt! with a rider owned Mountain Bike Tour Company 
      </h1>
    </header>
            ...
            <div class="single-caption-option">
              <div class="container">
                <div class="hero-caption">
                  <h2>
                    <?php the_field('big_thin_text') ?>
                    <span>
                      <?php the_field('big_bold_text') ?>
                    </span>
                  </h2>
                  <span class="dark">
                    <?php the_field('small_line_text') ?>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div class="row no-gutters">
            <div class="col-md-5">
              ...
              <div class="goRides">
                ...
                <a href="<?php echo site_url(); ?>/rides" title="Find Your Ride">Enter
                </a>
              </div>
            </div>
            <div class="col-md-7">
        ...
        <div class="intro-video-container">
          ...
          <div class="codegena">
            <iframe width='100px' height='59px'
                    src='https://player.vimeo.com/video/184178553?autoplay=1&title=0&loop=1&badge=0&byline=0&portrait=0&background=1&muted=1'>
            </iframe>
          </div>
        </div>
          ...
          <div class="row d-flex justify-content-center">
            <div class="col-md-9">
              <div class="section-title">
                ...
                <span>This is why we do what we do
                </span>
              </div>
